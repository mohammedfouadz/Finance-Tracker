  ...
  return (
    <Layout>
      ...
      <div className="space-y-4">
        {isLoading ? (
          <p className="text-center py-10 text-muted-foreground">Loading transactions...</p>
          ...
          transactions?.map((t) => {
            ...
            return (
              <div key={t.id} className="group flex items-center justify-between p-4 rounded-xl bg-card border hover:border-primary/50 hover:shadow-md transition-all duration-300">
                ...
                <div className="flex items-center gap-6">
                  <span className={`text-lg font-mono font-bold ${isIncome ? 'text-success' : 'text-foreground'}`}>
